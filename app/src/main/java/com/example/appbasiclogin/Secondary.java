...
import com.example.appbasiclogin.databinding.ActivitySecondaryBinding;
...
private ActivitySecondaryBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     setContentView(binding.getRoot());
        ...
        NavController navController = Navigation.findNavController(this, R.id.nav_host_fragment_content_secondary);
